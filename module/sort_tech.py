...
#num - Ввод строки для сравнения (Строка с содержанием номеров магазина)
...
def tech(task, num, col, direct, id_1, id_2, id_3, id_4, id_5, id_6, id_7, id_8, id_9, id_10):
    try:
        for i in range(col):
            num_tech = i + 1
            filter = open('../documents/' + direct + '_tech_' + str(num_tech) + '.txt', 'r', encoding='utf-8')
